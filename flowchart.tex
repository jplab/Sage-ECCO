...
\begin{tikzpicture}[question/.style={fill=blue!20, align=center, rectangle, rounded corners,inner sep=10pt},
	...
	\node[worksheet] (IntroPoly) at (4,-8) {Worksheet IV:\\ \texttt{Introduction to Polyhedral Geometry}};
	
	\node[worksheet] (CourseProb) at (-2,-11) {Worksheet V:\\ \texttt{Course Problems}};
